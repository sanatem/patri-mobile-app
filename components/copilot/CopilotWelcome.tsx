...
export function CopilotWelcome({ user, onSuggestionPress }: CopilotWelcomeProps) {
  ...
  return (
    <Container variant="secondaryPage" style={{ padding: 20}}>
      <Text className="font-bold text-primary-500 mb-3 mt-5 text-center" style={{ fontSize: 24 }}>
        Hola {userName}
      </Text>
      ...
      <View className="bg-gray-50 rounded-2xl p-5 flex-row items-center justify-between mb-6 w-full">
        <View className="flex-1">
          <Text className="text-base font-semibold text-gray-800 mb-1" style={{ paddingRight: 15, paddingLeft: 15, paddingTop: 20 }}>
            Asistente de Patrimore
          </Text>
          <Text className="text-sm font-regular text-gray-600 leading-5" style={{ paddingRight: 15, paddingLeft: 15, paddingBottom: 20 }}>
            Toca el botón para descubrir cómo puede ayudarte día a día.
          </Text>
        </View>
        <ChevronRight size={40} color="#9CA3AF" style={{ paddingRight: 15   }} />
      </View>
      </Container>
      <Container variant="secondaryPage" style={{ padding: 20}}>
      <SuggestionButtons 
